...
- Project name: Guiced Telemetry
- Short description: The GuicedEE Plugin for Vert.x Telemetry
- Repository host + URL: GuicedEE/GuicedTelemetry
- License: Apache-2.0
- Primary languages: Java 25
- Tech stack (tick all that apply):
  - Backend: [X] Vert.x 5  [ ] Hibernate Reactive 7  [X] DDD  [X] MapStruct  [X] Lombok  [X] Logging
  - Frontend: [ ] Angular 20  [ ] Web Components  [ ] JWebMP  [ ] WebAwesome
  - Infra/CI: [X] GitHub Actions  [ ] Terraform  [ ] GCP Cloud Run
  - Database: [ ] PostgreSQL  [ ] MySQL  [ ] Other: <DB_OTHER>
- Architecture: [ ] Monolith  [X] Microservices  [ ] Micro Frontends
